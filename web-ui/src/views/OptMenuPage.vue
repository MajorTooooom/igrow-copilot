<template>
  <div>
    <el-form :inline="true" ref="envCfgFormVo" :model="envCfgFormVo" label-width="120px" size="mini" class="env-cfg-form-class">
      ...
      <el-form-item>
        <el-upload
          ...
          <el-tooltip class="item" effect="dark" content="数量限制10" placement="top-start">
            <el-button size="mini" type="primary">选择模板文件&nbsp;&nbsp;<i class="fa fa-file"></i></el-button>
          </el-tooltip>
        </el-upload>
        <el-button size="mini" type="primary" @click="uploadFileListDialogVo.show=true">（查看已选）</el-button>
        <el-tooltip class="item" effect="dark" content="web展示" placement="top-start">
          <el-button type="primary" @click="renderToString">Web预览</el-button>
        </el-tooltip>
        <!--<el-tooltip class="item" effect="dark" content="zip打包下载" placement="top-start"><el-button type="primary">打包</el-button></el-tooltip>-->
        <el-tooltip class="item" effect="dark" content="内置模板直接生成到项目目录下,网页上传的模板在网页端查看" placement="top-start">
          <el-button type="primary" @click="renderToDir">渲染至目录</el-button>
        </el-tooltip>
      </el-form-item>
    </el-form>
    <el-dialog
...
import {getTableCfgOptionsFn, getGenCfgOptionsFn, renderToStringFn, renderToDirFn} from '@/api/optMenuApi';
